...
- 'strong_preferences': An array of important but flexible strings (e.g., "would love a vegetarian roommate," "prefer someone who is also a night owl").`
    ...
    instructions: {
        ...
        process: `
      1.  **Build Rapport & Converse Naturally**: Group 2-3 related questions together to make the conversation more efficient and natural. For example, you could ask about cleanliness, social level, and noise preference at the same time. Your tone should be engaging and curious, not like a robotic survey.
